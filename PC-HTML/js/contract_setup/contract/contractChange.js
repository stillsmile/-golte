layui.use(['form', 'layer', 'table', 'jquery', 'laydate', 'upload'], function () {
        ...
        ajaxJS(param, {cityId:$('.cityId').val()}, function (d) {
            ...
            if ($('.sign').val() == 'edit') {
                ...
                $('input').blur(function (){
                    ...
                    $(this).parents('.specTR').find('.subtotal').html(total.toFixed(2));
                    ...
                    $(this).parents('#table').find('.amount').html(sum.toFixed(2));
                })
                form.render()
            }
        });
    ...
    function add(data,status) {
        ...
        $(".specTR").each(function () {
            ...
            projects.push({
                id: $(this).find(".resourceProjectId").val(),
